...
all: emitter_test system_test cpu_test big_endian_test runtime_test \
	alloc_free_test tables_test source_test scanner_test np0 npx0 test_nx
...
np0: np0.c parser.h runtime.h big_endian.h cpu.h system.h opcode.h source.h \
		parser.o generator.o scanner.o source.o tables.o alloc_free.o \
		runtime.o big_endian.o cpu.o system.o emitter.o
	$(CC) $(CFLAGS) np0.c -o np0 \
		parser.o generator.o scanner.o source.o tables.o alloc_free.o \
		runtime.o big_endian.o cpu.o system.o emitter.o

npx0: npx0.c runtime.h system.h \
		runtime.o big_endian.o cpu.o system.o
	$(CC) $(CFLAGS) npx0.c -o npx0 \
		runtime.o big_endian.o cpu.o system.o
